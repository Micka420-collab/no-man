...
| 🗺️ **Galaxies** | Carte galactique immersive **façon Galactic Atlas** : galaxie spirale lumineuse (cœur brillant, bras spiraux logarithmiques, voies de poussière, effet de halo/bloom), zoom, navigation, chemin parcouru, marqueur « je suis ici », avec les **galaxies les plus vivantes** mises en avant (Euclid, Eissentam…) | Rendu maison + hubs communautaires |
