...
| 📜 **Missions** | Wiki des **missions & quêtes** : histoire principale (Éveils, Chemin d'Artémis, Chemin de l'Atlas, La Purge), grandes quêtes annexes (Autophages/Bâton Voltaïque, Naissance stellaire, base & recrutement) et missions de l'Anomalie (Nexus/Quicksilver), avec objectifs, étapes, récompenses et **détails cachés**. En vedette : **« Le secret du 16 »**, le nombre-signature caché de No Man's Sky (16 minutes de l'Atlas, 16 glyphes, 16¹⁶ planètes, Loop16/Waking Titan, Telamon) | Wiki No Man's Sky + forums |
