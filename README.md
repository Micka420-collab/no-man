...
| ⚛️ **Éléments** | Le **tableau périodique** des substances réelles du jeu, regroupées par famille (organiques, ferrites, métaux stellaires, gaz atmosphériques, précieux, terrestres, aquatiques, flore…) ; symbole chimique réel quand la substance en est un (Na, Au, O₂, He, U, Cl…) sinon abréviation du nom in-game, avec valeur et icône. Clic → fiche détaillée, favori ⭐ et partage 🔗 | Données du jeu via Assistant NMS (mise en page maison) |
...
| 💎 **Marché** | Classements des objets les plus précieux, **assistant de pêche « quoi pêcher ici, maintenant ? »** (croise les **225 poissons** avec ton biome, le moment jour/nuit et la tempête — tri par valeur, compteur et badges de conditions), guide des vaisseaux avec **vraies images en jeu**, conseils d'obtention et **guide d'amélioration au max** (emplacements survolimentés, adjacence, classes S/X) | Données Assistant NMS + images du wiki NMS |
